                        ...
                        <div className="project-grid flex-fill">
                            {projectData.map((project) => {
                                return (
                                    <Col key={project.id}>
                                        <Card>
                                            <Card.Img variant="top" src={project.screenshot} alt={project.title} />
                                            <Card.Body>
                                                <Card.Title>
                                                    {project.title}
                                                </Card.Title>
                                                ...
                                                <Button variant="primary" href={project.url} size="small">
                                                    View
                                                </Button>
                                                <Button variant="secondary" href={project.github} size="small">
                                                    GitHub
                                                </Button>
                                            </Card.Body>
                                        </Card>
